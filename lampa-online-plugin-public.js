(function () {
    ...
    function startPlugin() {
        window.online_plugin = new OnlinePlugin();

        Lampa.Component.add('online_public', component);
        ...
        function component(object) {
            ...
            this.search = function () {
                ...
                window.online_plugin.search(object, function (results) {
                    loading = false;
            ...
            this.start = function () {
                if (selected.source) {
                    var iframe_url = window.online_plugin.getIframe(
                        selected.source,
                        selected.kp_id,
                        selected.imdb_id
                    );
